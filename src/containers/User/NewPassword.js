	...
	return (
      ...
      <div className="flex py-5 font-bold">
          ...
          <div className="flex flex-col">
            <label htmlFor="pass" className="after:content-['*'] after:ml-0.5 block">Password</label>
            <input
              type="password"
              id="pass"
            ...
            />
            <label htmlFor="pass1" className="after:content-['*'] after:ml-0.5 block">Confirm Password</label>
            <input
              type="password"
              id="pass1"
              placeholder="Password..."
              ...
              className="h-8 outline-0"
            />
            <button disabled={isLoading ? true : false} className="bg-slate-800 text-white mx-5 my-4 p-3 rounded-md font-bold hover:bg-slate-700">Reset Password</button>
          </div>
        </form>
			</div>
		</>
